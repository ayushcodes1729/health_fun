...
export function initializeConfig(
  ...
  if (!resolvedAccounts.treasuryPda.value) {
    resolvedAccounts.treasuryPda.value = context.eddsa.findPda(programId, [
      bytes().serialize(
        new Uint8Array([116, 114, 101, 97, 115, 117, 114, 121])
      ),
      publicKeySerializer().serialize(
        expectPublicKey(resolvedAccounts.stakeConfig.value)
      ),
    ]);
  }
